...
module "deaddrop_frontend" {
  ...
  domain_name         = "deaddrop.${local.resource_identifier}.fiipractic-2026.ro"
  ...
  build_environment = {
    "VITE_API_URL" = "https://api.deaddrop.${local.resource_identifier}.fiipractic-2026.ro"
  }
...
module "deaddrop_backend" {
  ...
  domain_name        = "api.deaddrop.${local.resource_identifier}.fiipractic-2026.ro"
  hosted_zone_id     = data.aws_route53_zone.main_hosted_zone.id
}
